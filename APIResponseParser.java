public class APIResponseParser {
	 ...
	 */
     public static Book parse(String response) {
	    ...
	    book.setTitle(title);
	    int publicationYear = parse(response, startRule, endRule);
	    book.setPublicationYear(publicationYear);
	    String author = parse(response, startRule, endRule); 
	    book.setAuthor(author);
	    double averageRating = parse(response, startRule, endRule); 
	    book.setAverageRating(averageRating);
	    int ratingsCount = parse(response, startRule, endRule); 
